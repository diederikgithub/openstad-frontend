    ...
    self.load = function (req, widgets, callback) {
      return superLoad(req, widgets, function (err) {
        ...
        widgets.forEach((widget) => {
          ...
          widget.contentWidgets = self.apos.permissions.can(req, 'admin') ? contentWidgets.getAdminWidgets(widgetDisplaySettings) : contentWidgets.getEditorWidgets(widgetDisplaySettings);
        });
